...
c.DockerSpawner.args = ['--NotebookApp.default_url=/apps/simpleice.ipynb']
# Edit mode: 
# c.DockerSpawner.args = ['--NotebookApp.default_url=/notebooks/simpleice.ipynb']

...
c.DockerSpawner.args = ['--NotebookApp.default_url=/apps/alps.ipynb']
# Edit mode: 
# c.DockerSpawner.args = ['--NotebookApp.default_url=/notebooks/alps.ipynb']

...
c.DockerSpawner.args = ['--NotebookApp.default_url=/apps/main.ipynb']
# Edit mode: 
# c.DockerSpawner.args = ['--NotebookApp.default_url=/notebooks/main.ipynb']

...
c.DockerSpawner.args = ['--NotebookApp.default_url=/apps/GHub.ipynb']
# Edit mode: 
# c.DockerSpawner.args = ['--NotebookApp.default_url=/notebooks/GHub.ipynb']

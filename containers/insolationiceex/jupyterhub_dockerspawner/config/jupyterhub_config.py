...
c.DockerSpawner.args = ['--NotebookApp.default_url=/apps/insolation-ice-volume-explorer.ipynb']
# Edit mode: 
#c.DockerSpawner.args = ['--NotebookApp.default_url=/notebooksinsolation-ice-volume-explorer.ipynb']

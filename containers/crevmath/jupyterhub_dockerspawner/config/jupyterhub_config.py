...
c.DockerSpawner.args = ['--NotebookApp.default_url=/apps/crevmath.ipynb']
# Edit mode: 
# c.DockerSpawner.args = ['--NotebookApp.default_url=/notebooks/crevmath.ipynb']

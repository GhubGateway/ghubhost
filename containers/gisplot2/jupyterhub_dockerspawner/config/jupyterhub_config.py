...
c.DockerSpawner.image =  'gisplot2_tool_image:latest'

# Connect containers to the JupyterHub network
c.DockerSpawner.network_name = 'jupyterhub-network'

# Mount a persistent volume for each user's work
notebook_dir = '/home/{username}/gisplot2'
c.DockerSpawner.notebook_dir = notebook_dir
c.DockerSpawner.volumes = {
    'jupyterhub-user-{username}': notebook_dir,
    f'/Users/renettej/AAA_Ghub_Tools/Ghub_Tools/containers/gisplot2/input-data': {"bind": "/home/{username}/input-data", "mode": "ro"},
    f'/Users/renettej/AAA_Ghub_Tools/Ghub_Tools/containers/gisplot2/generated-data': {"bind": "/home/{username}/generated-data", "mode": "rw"}
}

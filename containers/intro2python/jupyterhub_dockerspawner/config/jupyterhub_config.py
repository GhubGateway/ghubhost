...
#c.DockerSpawner.args = ['--NotebookApp.default_url=/apps/intro2python.ipynb']
# Edit mode: 
c.DockerSpawner.args = ['--NotebookApp.default_url=/notebooks/intro2python.ipynb']
